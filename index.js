...
/////////////////
const BotName = 'YwNBoT'; 
const instagram = 'https://www.instagram.com/yuanabdillah/'; 
const telegram = 'https://t.me/ywnabdillah'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const whatsapp = '085757122558';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@yuanabdillah')
